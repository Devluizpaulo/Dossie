...
export const sections = [
  ...
  },
  {
    ...
    content: (
      <>
        <p><strong>Área:</strong> Tecnologia da Informação/Gestão Operacional</p>
        <p><strong>Responsável:</strong> Luiz Paulo Gonçalves Miguel de Jesus</p>
    ...
    content: (
        <>
        <p className="italic mb-4">(Leitura Obrigatória)</p>
        <p className="mb-4">
        ...
        <p className="mb-4">Como consequência direta dessa abordagem de “cópia e adaptação”, o sistema atual apresenta os seguintes efeitos combinados e críticos:</p>
    ...
    content: (
        <>
            <p className="mb-4">Além de seu caráter técnico, este documento constitui a base formal e auditável para:</p>
            <ul className="list-disc pl-6 space-y-2">
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">Catalogar, de forma estruturada, todas as falhas, inconsistências, bugs e deficiências identificadas no sistema.</p>
                ...
                <p className="mb-4">Expor e analisar os riscos inerentes à operação da plataforma, abrangendo dimensões operacionais, tecnológicas, financeiras e jurídicas.</p>
                <h3 className="text-xl font-semibold mb-2 mt-4" id={slugify("Suporte à Decisão Estratégica")}>Suporte à Decisão Estratégica</h3>
                <p className="mb-4">Constituir acervo documental apto a subsidiar decisões estratégicas de alto impacto, com base técnica e evidencial.</p>
                ...
                <p>Servir como padrão técnico e ponto de partida para correções pontuais, projetos de reengenharia profunda ou eventual substituição integral do sistema.</p>
            </>
        )
    },
    {
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">Análise do sistema em uso real, considerando cenários operacionais efetivamente executados pelas equipes internas e clientes, permitindo a identificação de fragilidades práticas e recorrentes.</p>
                ...
                <p className="mb-4">Verificação sistemática das funcionalidades, fluxos e regras de negócio do sistema atual em contraste com o sistema legado, com foco em perdas funcionais, divergências conceituais e regressões operacionais.</p>
                <h3 className="text-xl font-semibold mb-2 mt-4" id={slugify("Estudo dos Fluxos Operacionais")}>Estudo dos Fluxos Operacionais</h3>
                <p className="mb-4">Avaliação dos fluxos críticos de negócio, identificando pontos de intervenção manual, dependências externas, quebras de automação e fragilidades de rastreabilidade.</p>
                <h3 className="text-xl font-semibold mb-2 mt-4" id={slugify("Observação Técnica Direta")}>Observação Técnica Direta</h3>
                <p className="mb-4">Registro técnico das limitações estruturais, inconsistências funcionais e lacunas de governança observadas durante a operação, sem a utilização de inferências ou hipóteses não verificáveis.</p>
                <h3 className="text-xl font-semibold mb-2 mt-4" id={slugify("Referência aos Anexos")}>Referência aos Anexos</h3>
                <p>Os fluxos detalhados, exemplos práticos, registros operacionais e evidências técnicas que fundamentam esta metodologia encontram-se consolidados no Anexo I – Evidências Técnicas e Operacionais e no Anexo II – Matriz de Paridade Funcional (Sistema Legado x Sistema Atual).</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                ...
                <p><strong>Referência aos Anexos:</strong> A relação completa de não conformidades, exemplos práticos e impactos associados a cada área está detalhada nos Anexos I, II e III.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">Como consequência direta dessa herança não reestruturada, foram observados:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p><strong>Referência aos Anexos:</strong> A análise comparativa entre arquitetura legada e atual encontra-se detalhada no Anexo II – Matriz de Paridade Funcional.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4"><strong>Fluxo AS-IS – Solicitação de CDE:</strong></p>
                ...
                <p className="mb-4">O fluxo atual de CDE apresenta os seguintes problemas críticos:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Apesar da existência da página de solicitação no sistema, o fluxo não é end-to-end, o que compromete seu propósito funcional.</p>
                ...
                <p className="mb-4">A situação observada no fluxo de CDE não pode ser classificada como limitação pontual ou melhoria futura, pois:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Trata-se, portanto, de não conformidade estrutural, equivalente aos fluxos de movimentação de saldo e pedidos de certificados.</p>

                <h3 className="text-xl font-semibold mb-2 mt-4" id={slugify("6.4 Diretriz de Correção (TO-BE)")}>6.4 Diretriz de Correção (TO-BE)</h3>
                <p className="mb-4">O fluxo ideal de solicitação de CDE deve ser reestruturado para operar integralmente dentro da plataforma, contemplando:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">O papel do back-office deve ser supervisório, e não operacional.</p>
                ...
                <p className="mb-4">A manutenção da emissão de boletos fora do sistema representa:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Recomenda-se a integração via API com o provedor de cobrança atualmente utilizado (OMIE) ou equivalente, garantindo:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p><strong>Referência aos Anexos:</strong> Os fluxos AS-IS e TO-BE da solicitação de CDE encontram-se documentados no Anexo I – Evidências Técnicas e Operacionais, juntamente com os fluxos de intenção de movimentação e pedidos de certificados.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                <p className="italic mb-4">(Com referência visual aos fluxos operacionais – AS-IS x TO-BE)</p>
                ...
                <p className="mb-4"><strong>Figura 1 – Jornada das UCSs no Sistema BMV (AS-IS) x Jornada das UCSs na Blockchain (TO-BE)</strong><br/>(Fluxograma anexo elaborado pela equipe técnica da BMV)</p>
                ...
                <p className="mb-4">Nesse modelo:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Essa abordagem compromete a integridade do modelo de tokenização e impede que a Blockchain exerça seu papel como camada de confiança e motor transacional do sistema.</p>
                ...
                <p className="mb-4">A análise técnica identificou fragilidades estruturais críticas no modelo atual:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Essas fragilidades tornam o modelo operacional incompatível com cenários de crescimento, múltiplas safras e aumento do volume transacional.</p>
                ...
                <p className="mb-4">Esse modelo assegura mutabilidade auditável, integridade transacional e escalabilidade real do sistema.</p>
                ...
                <p className="mb-4">A ausência dessa integração estrutural gera riscos críticos em cenários de escala:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Com base na análise e no fluxo TO-BE apresentado, estabelecem-se como diretrizes técnicas obrigatórias:</p>
                <ul className="list-disc pl-6 space-y-2">
                 ...
                 <p className="mt-4"><strong>Referência aos Anexos:</strong> Anexo I – Evidências Técnicas e Operacionais; Anexo III – Matriz de Risco; Anexo V – Cenários de Tokenização e Movimentação de UCSs.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">O sistema não adota uma identidade de negócio única e consistente, utilizando identificadores técnicos distintos entre tabelas e módulos.</p>
                <h3 className="text-xl font-semibold mb-2 mt-4" id={slugify("8.2 Impactos Observados")}>8.2 Impactos Observados</h3>
                <p className="mb-4">Essa abordagem compromete:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p><strong>Referência aos Anexos:</strong> Os impactos práticos e exemplos de inconsistência encontram-se descritos no Anexo III – Matriz de Risco do Sistema BMV.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-2"><strong>Nomes Incompletos:</strong> Em alguns cenários, o sistema exibe apenas o primeiro nome do usuário, mesmo quando o cadastro foi corretamente preenchido com nome e sobrenome.</p>
                <p className="mb-4"><strong>Análise:</strong> Essa falha compromete a identificação inequívoca do cliente, impacta relatórios operacionais e gerenciais e fragiliza a governança dos dados cadastrais. A exibição incompleta do nome em diferentes telas gera inconsistência na experiência do usuário e aumenta o risco de duplicidade ou erro na interpretação de registros.</p>
                <p className="mb-4"><strong>Referência ao Anexo:</strong> As evidências técnicas, incluindo a relação de telas afetadas e registros operacionais associados, encontram-se detalhadas no Anexo I – Evidências Técnicas e Operacionais.</p>
                ...
                <p className="mb-2"><strong>Arquivamento Lógico Ausente:</strong> Não há um processo formal e estruturado para o arquivamento lógico de usuários que deixaram de interagir com o ecossistema (e-commerce), mantendo registros inativos na base operacional ativa.</p>
                <p className="mb-2"><strong>Impossibilidade de Exclusão Definitiva:</strong> Inexiste funcionalidade para a exclusão física e permanente de cadastros (clientes ou registros), inclusive em casos de erro de preenchimento, duplicidade ou encerramento da relação comercial.</p>
                <p className="mb-4"><strong>Análise:</strong> A ausência de mecanismos adequados para o gerenciamento do ciclo de vida dos usuários gera acúmulo indevido de dados, aumenta a dívida técnica da base cadastral e impacta negativamente a performance do sistema. Além disso, expõe a empresa a riscos de compliance e governança da informação, ao manter registros desnecessários, desatualizados ou incorretos na base ativa.</p>
                <p><strong>Referência ao Anexo:</strong> O detalhamento do fluxo operacional atual, bem como a avaliação de riscos associados, encontra-se descrito no Anexo III – Matriz de Risco do Sistema BMV.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4"><strong>Referência ao Anexo:</strong> A matriz comparativa completa entre os estados de saldo do sistema legado e do sistema atual encontra-se no Anexo II – Matriz de Paridade Funcional (Sistema Legado x Sistema Atual).</p>
                ...
                <p className="mb-4">Em resposta formal, a Multiledgers esclareceu que a limitação de filtros na tela de movimentações foi uma decisão intencional de escopo, adotada com o objetivo de acelerar a disponibilização da plataforma e permitir a rápida operacionalização das transações com clientes externos da BMV.</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4"><strong>Referência ao Anexo:</strong> O posicionamento formal do fornecedor e os registros de alinhamento encontram-se consolidados no Anexo I – Evidências Técnicas e Operacionais.</p>
                ...
                <p className="mb-4">Foram identificadas as seguintes consequências:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Adicionalmente, observou-se que:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Como consequência prática, operações de transferência podem ser interpretadas como distribuições, distorcendo a lógica financeira e contábil do fluxo.</p>
                <p className="mb-4"><strong>Referência ao Anexo:</strong> Os cenários analisados e os exemplos de distorção de classificação encontram-se detalhados no Anexo II – Matriz de Paridade Funcional.</p>
                ...
                <p className="mb-4">Trata-se de uma não conformidade de impacto transversal, afetando confiabilidade, auditoria, conciliação e governança dos dados transacionais.</p>
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">Do ponto de vista de governança, trata-se de não conformidade funcional crítica, com impacto direto em auditorias, SLA operacionais e experiência do usuário interno.</p>
                <p className="mb-4"><strong>Referência ao Anexo:</strong> Os fluxos afetados e os registros de inconsistência encontram-se detalhados no Anexo I – Evidências Técnicas e Operacionais.</p>
                ...
                <p><strong>Referência ao Anexo:</strong> A avaliação de impacto e os riscos associados à ausência de versionamento encontram-se descritos no Anexo III – Matriz de Risco do Sistema BMV.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                <p className="mb-4">Foram identificadas deficiências relevantes na experiência do usuário, incluindo:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p><strong>Referência ao Anexo:</strong> Os exemplos práticos e evidências relacionadas à usabilidade encontram-se consolidados no Anexo I – Evidências Técnicas e Operacionais.</p>
            </>
        )
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">Essa limitação afeta operações críticas, tais como:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">A ausência de trilha de auditoria gera impactos diretos nos seguintes pilares:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-2"><strong>Não Conformidade Estrutural de Governança e Auditabilidade.</strong></p>
                <p className="mb-4">
                ...
                <p className="mb-4">Recomenda-se a implementação de um mecanismo formal de trilha de auditoria (audit trail), contemplando, no mínimo:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p><strong>Referência ao Anexo:</strong> Os exemplos práticos, fluxos afetados e evidências da ausência de rastreabilidade encontram-se detalhados no Anexo I – Evidências Técnicas e Operacionais.</p>
            </>
        )
    },
    {
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">Este corpo principal estabelece:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">As não conformidades constantes nos anexos:</p>
                <ul className="list-disc pl-6 space-y-2">
    ...
    },
    {
        ...
        content: (
            <>
                ...
                <p className="mb-4">Os itens aqui enquadrados impactam diretamente:</p>
                <ul className="list-disc pl-6 space-y-2 mb-4">
                ...
                <p className="mb-4">Os registros desta seção referenciam diretamente:</p>
                <ul className="list-disc pl-6 space-y-2">
    ...
    },
    {
        ...
        content: (
            <>
                <p className="mb-4">Este dossiê fornece base técnica, documental e objetiva para:</p>
                <ul className="list-disc pl-6 space-y-2">
    ...
    },
    {
        ...
        content: (
            <p><strong>Luiz Paulo Gonçalves Miguel de Jesus</strong> — Data: 05/01/2026</p>
        )
    }
];
      ...
      {sections.map((section, index) => {
        ...
        return (
          <AccordionItem value={id} key={id} id={id}>
            ...
            <AccordionContent className="prose prose-lg dark:prose-invert max-w-none text-foreground text-base leading-relaxed space-y-4 pt-4">
